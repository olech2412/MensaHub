...
public class StaticEmailText {
    ...
    public final static String FOOD_PLAN_TEXT = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">" +
            ...
            "<h1 class=\"h3\" style=\"padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;\" align=\"left\">%s</h1>" +
            ...
            "</tbody>" +
            "</table>" +
            "<h5 class=\"text-teal-700\" style=\"color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;\" align=\"left\">%s</h5>" +
            ...
            "</table>" +
            "<div class=\"space-y-3\">" +
            "<p class=\"text-gray-700\" style=\"line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;\" align=\"left\">%s %s, </p>" +
    ...
    public final static String FOOD_TEXT =
            "<p class=\"text-gray-700\" style=\"line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;\" align=\"left\">%s</p>" +
                    "<p class=\"text-gray-700\" style=\"line-height: 24px; font-size: 12px; color: #4a5568; width: 100%; margin: 0;\" align=\"left\">Allergene und oder Zusatzstoffe: %s</p>" +
                    "<table class=\"s-3 w-full\" role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width: 100%;\" width=\"100%\">" +
                    "<tbody>" +
                    "<tr>" +
                    "<td style=\"line-height: 12px; font-size: 12px; width: 100%; height: 12px; margin: 0;\" align=\"left\" width=\"100%\" height=\"12\">" +
    ...
    public final static String FOOD_PLAN_FOOTER =
            "<div>" +
                    "<p class=\"text-gray-700\" style=\"line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;\" align=\"left\">%s</p>" +
                    "<p class=\"text-gray-700\" style=\"line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;\" align=\"left\">dein MensaHub-DataDispatcher</p>" +
                    "</div>" +
                    "</div>" +
                    "<table class=\"s-5 w-full\" role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width: 100%;\" width=\"100%\">" +
                    "<tbody>" +
                    ...
                    "<a href=\"%s\" target=\"_blank\" style=\"color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;\">MensaHub-Einstellungen ⚙️</a>" +
                    "</td>" +
                    "</tr>" +
                    "</tbody>" +
                    "</table>" +
    ...
    public static final String HEADER_COLLAB = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">\n" +
            "<html>\n" +
            "  <head>\n" +
            ...
            "                                              </tbody>\n" +
            "                                            </table>\n" +
            "                                            <h2 class=\"card-title\" style=\"padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 32px; line-height: 38.4px; margin: 0;\" align=\"left\">Empfehlung f&#252;r deinen n&#228;chsten Mensabesuch</h2>\n" +
            "                                            <table class=\"s-3 w-full\" role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width: 100%;\" width=\"100%\">\n" +
            "                                              <tbody>\n" +
            "                                                <tr>\n" +
            "                                                  <td style=\"line-height: 12px; font-size: 12px; width: 100%; height: 12px; margin: 0;\" align=\"left\" width=\"100%\" height=\"12\">\n" +
            ...
            "                                              </tbody>\n" +
            "                                            </table>\n" +
            "                                            <h5 class=\"card-text text-success\" style=\"color: #198754; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;\" align=\"left\">%RandomFunnyText</h5>\n" +
            "                                            <table class=\"s-5 w-full\" role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width: 100%;\" width=\"100%\">\n" +
            "                                              <tbody>\n" +
            "                                                <tr>\n" +
            "                                                  <td style=\"line-height: 20px; font-size: 20px; width: 100%; height: 20px; margin: 0;\" align=\"left\" width=\"100%\" height=\"20\">\n" +
            ...
            "                                            </table>\n" +
            "                                            <div>\n" +
            "                                              <p class=\"text-gray-700\" style=\"line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;\" align=\"left\">%RandomFunnyWelcomeText %firstName,</p>\n" +
            "                                              <p class=\"text-gray-700\" style=\"line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;\" align=\"left\">nachfolgend werden dir m&#246;gliche Empfehlungen f&#252;r Mensagerichte f&#252;r morgen in deinen abonnierten\n" +
            "                                                Mensen angezeigt.</p>\n" +
            "                                              <br>\n" +
            "                                            </div>";
