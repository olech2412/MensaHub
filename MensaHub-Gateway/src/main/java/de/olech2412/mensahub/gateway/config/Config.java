package de.olech2412.mensahub.gateway.config;
...
public class Config {
    ...
    private void initialEncryption() throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, IOException {
        ...
        propertiesToEncrypt.add("mensaHub.api.security.jwt.secret-key");
        propertiesToEncrypt.add("mensaHub.api.security.jwt.expiration-time");
    ...
    private void updateProperties() throws IOException {
        ...
        properties.store(out, "Updated from MensaHub-Gateway");
